...
const CourseHeader = ({ course, title }: Props) => {
    const [currentLesson, setCurrentLesson] = useState(0);

    return <div className="w-full p-6 text-left bg-green-200 divide-y divide-gray-400"> {/*coure*/}
        <div>
            <div className="w-full px-7 text-left flex">
                <div className='rounded-full bg-slate-50 text-center align-middle w-1/6 my-auto'>
                    <Image src={books} height={80} width={80} alt="course" />
                </div>
        ...
        <div className='pt-6 flex justify-between'>
            ...
            <Link href={`/course/${course}/${currentLesson+1}`}>
